...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>GADE RENTAL</title>
      <meta name="keywords" content="">
      <meta name="description" content="">
      <meta name="author" content="">
      <!-- bootstrap css -->
      <!-- <link rel="stylesheet" href="css/bootstrap.min.css"> -->
      <link rel="stylesheet" href={{asset("assets/rental/css/bootstrap.min.css")}}>
      <!-- style css -->
      <!-- <link rel="stylesheet" href="css/style.css"> -->
      <link rel="stylesheet" href={{asset("assets/rental/css/style.css")}}>
      <!-- Responsive-->
      <!-- <link rel="stylesheet" href="css/responsive.css"> -->
      <link rel="stylesheet" href={{asset("assets/rental/css/responsive.css")}}>
      <!-- fevicon -->
      <!-- <link rel="icon" href="images/fevicon.png" type="image/gif" /> -->
      <link rel="icon" href={{asset("assets/rental/images/fevicon.png")}} type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href={{asset("assets/rental/css/mCustomScrollbar.min.css")}}>
   ...
   <body class="main-layout">
      ...
      <div class="loader_bg">
         ...
         <div class="loader"><img src={{asset("assets/rental/images/loading.gif")}} alt="#" /></div>
      </div>
      <!-- end loader -->
            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-4 col-sm-4">
                     <div class="logo">
                        <a href="index.html"><img src={{asset("assets/rental/images/logo.png")}} alt="#" /></a>
                     </div>
                  </div>
                  <div class=" col-md-6 col-sm-6">
                     <ul class="conat_info d_none ">
                        <li><a href="#">(+71) 8522369417</a></li>
                        <li><a href="#">democar@gmail.com</a></li>
                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="right_bottun">
                        ...
                        <button class="openbtn" onclick="openNav()"><img src={{asset("assets/rental/images/menu_icon.png")}} alt="#"/> </button> 
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="select-box">
                                 <label for="select-box1" class="label select-box1"><span class="label-desc">Select your car type</span> </label>
                           ...
                           <div class="col-md-12">
                              ...
                              <input class="form_luxury max_low" placeholder="Enter your city airport" type="type" name="Enter your city airport">
                           </div>
                           <div class="col-md-6">
                              <label>Picking up date</label>
                              <input class="form_luxury max_wi" placeholder="Enter your city airport" type="date" name="Enter your city airport">
                           ...
                           <div class="col-md-12">
                              <button class="tinueCar">Continue Car Reservation</button>
                           </div>
                        </div>
                     </form>
                  </div>
      ...
      <script src={{asset("assets/rental/js/jquery.min.js")}}></script>

      <!-- <script src="js/popper.min.js"></script> -->
      <script src={{asset("assets/rental/js/popper.min.js")}}></script>

      <!-- <script src="js/bootstrap.bundle.min.js"></script> -->
      <script src={{asset("assets/rental/js/bootstrap.bundle.min.js")}}></script>

      <!-- <script src="js/jquery-3.0.0.min.js"></script> -->
      <script src={{asset("assets/rental/js/jquery-3.0.0.min.js")}}></script>

      <!-- sidebar -->
      <!-- <script src="js/jquery.mCustomScrollbar.concat.min.js"></script> -->
      <script src={{asset("assets/rental/js/jquery.mCustomScrollbar.concat.min.js")}}></script>

      <!-- <script src="js/"></script> -->
      <script src={{asset("assets/rental/js/custom.js")}}></script>
